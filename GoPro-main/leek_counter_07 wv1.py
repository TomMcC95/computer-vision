...
df.to_excel(cwd + d + output_directory_name + d + results_file_name + ".xlsx", index = False)
np.savetxt(cwd + d + output_directory_name + d + results_file_name + "_signal.csv", leek_signal_record, delimiter=",")
